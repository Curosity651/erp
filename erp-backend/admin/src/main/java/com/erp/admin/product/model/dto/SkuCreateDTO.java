 ...
 */
@Data
@Schema(title = "SKU创建DTO")
@ValidTaxRate
public class SkuCreateDTO implements TaxRateValidatable {
	...
	@Schema(title = "产品状态", description = "1:在售 2:停售 3:开发中 4:已下架，默认为1")
	...
	@Schema(title = "头程", description = "1:陆运 2:空运，默认为1")
	...
	@Schema(title = "计费重类型", description = "1=取大值，2=实重，3=体积重，默认为1")
	private Integer billingWeightType = 1;
	...
	@Schema(title = "重量单位", description = "默认KG")
	...
	@Schema(title = "包装单位", description = "默认M")
	private String packageUnit = "M";
