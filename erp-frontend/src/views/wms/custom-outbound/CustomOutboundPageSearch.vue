      ...
      <a-row :gutter="[16, 8]">
        ...
        <a-col :xl="6" :lg="8" :md="12" :sm="24">
          <a-form-item label="单据状态">
            ...
            >
              <a-select-option
                v-for="(label, value) in CustomOutboundStatusMap"
                :key="value"
                :value="value"
              >
                {{ label }}
...
import type { CustomOutboundQO } from '@/api/wms/custom-outbound/types'
import { CustomOutboundTypeMap, CustomOutboundStatusMap } from '@/api/wms/custom-outbound/types'
...
const emits = defineEmits<{
  (e: 'search', params: CustomOutboundQO): void
}>()

const formModel = reactive<CustomOutboundQO>({
